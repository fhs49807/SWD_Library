...
public class OrderServiceTest {
    ...
    public void whenNewOrderWithCredit_thenReturnOrder() {
        // given
    	Date now = new Date();
    	Customer customer = new Customer("test","junittest","test@test.tst", "123456", now, "none", "USER", null);
    	...
    	given(userService.hasCredit(any(Customer.class))).willReturn(true);
    ...
    public void whenNewOrderNoCredit_thenReturnNull() {
    	...
    	given(userService.hasCredit(any(Customer.class))).willReturn(false);
    	//repo is mocked but should return the order in case of success
